    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="/webbanhang/">Start Bootstrap</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex">
                        <button class="btn btn-outline-dark" type="submit" >
                            <a class="link" style="color: #000;" href="/webbanhang/view/cart/viewCart">
                    ...
                    <form class="d-flex" style="margin-left: 10px;">
                        <button class="btn btn-outline-dark" type="submit">
                            <a class="link" style="color: #000;" href="/webbanhang/view/login">
                                Login
                            </a>
                        </button>
                    </form>
                ...
                foreach ($data as $item){?>   
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <a class="card-footer p-4 pt-0 border-top-0 bg-transparent text-center" href="/webbanhang/view/product/?id=<?php echo $item['id']; ?>"><button class="btn btn-outline-dark">View options</button></a>
                        </div>
                    </div>
                <?php } }?>
            </div>
