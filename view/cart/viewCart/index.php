<?php
require_once("../updateOrder/update.php");
require_once("viewCart.php");
require_once("../deleteProduct/delete.php");
...
<form method="POST">
    <div class="container padding-bottom-3x mb-1">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center">
                            <button class="btn btn-sm btn-outline-danger" type="submit" name="deleteAll" value="<?php echo $data[0]['order_id'];?>">Clear Cart</button>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr> 
                        ...
                        <td class="text-center">
                            <form method="POST">
                                <button class="btn left-margin" type="submit" name="delete" value="<?php echo $item['id']?>"><i class="fa fa-trash"></i></button>
                            </form>
                        </a></td>
                    </tr>
                    <?php }
        ...
        <div class="shopping-cart-footer">
            <div class="column"><a class="btn btn-outline-secondary" href="/webbanhang/"><i class="icon-arrow-left"></i>&nbsp;Back to Shopping</a></div>
            <div class="column">
                <button class="btn btn-primary" type="submit" name="update" value="<?php echo $data[0]['order_id'];?>">Update</button>
                <a class="btn btn-success" href="/webbanhang/view/checkout/?id=<?php echo $item['order_id']?>">Checkout</a>
            </div>
        </div>
    </div>
</form>
